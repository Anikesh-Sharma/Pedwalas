...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In a real app, you might send formData and cartItems to your backend.
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-2/3">
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <h3 className="text-xl font-semibold mb-4 pb-2 border-b">Shipping Details</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <label htmlFor="card" className="ml-3 block">
                    ...
                    <div className="flex space-x-2 mt-1">
                      <span className="px-2 py-1 bg-gray-100 rounded-md text-xs">VISA</span>
                      <span className="px-2 py-1 bg-gray-100 rounded-md text-xs">Mastercard</span>
                      <span className="px-2 py-1 bg-gray-100 rounded-md text-xs">RuPay</span>
                    </div>
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="upi" className="ml-3 block">
                    ...
                    <div className="flex space-x-2 mt-1">
                      <span className="px-2 py-1 bg-gray-100 rounded-md text-xs">GooglePay</span>
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-6">
              <h3 className="text-xl font-semibold mb-4 pb-2 border-b">Order Summary</h3>
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <div className="flex justify-between font-bold text-lg pt-2 border-t">
                  <span>Total</span>
                  <span>Rs. {Math.round(total * 1.18).toLocaleString("en-IN")}</span>
                </div>
              </div>
            ...
            <Link to="/cart" className="flex items-center justify-center mt-4 text-blue-600 hover:underline">
