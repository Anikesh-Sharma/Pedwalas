...
// Handlers to support both mouse and keyboard interactions
const handleFocus = (index) => setHoveredProduct(index);
const handleBlur = () => setHoveredProduct(null);

return (
  <section className="bg-slate-50 py-12" aria-label="Featured Products Section">
    <motion.div
          ...
          return (
            ...
            >
              <div
                ...
                aria-label={`Product: ${product.name}, Price: ${formatIndianRupees(
                  product.price
                )}`}
              >
                <Link to={`/product/${productId}`}>
                  <div className="relative">
                    ...
                    {hoveredProduct === index && (
                      ...
                      >
                        <button
                          className="bg-white text-slate-800 px-4 py-1 rounded-full text-sm hover:bg-indigo-50 transition"
