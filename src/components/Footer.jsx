  ...
  <footer className="border-t border-gray-200 pt-8 pb-8">
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between">
        ...
        {/* Help Links Section */}
        <nav aria-label="Footer Help Links" className="mb-6 md:mb-0">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/refund" className="text-sm hover:underline">
                Refund Policy
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/cancellation" className="text-sm hover:underline">
                Cancellation Policy
              </a>
            </li>
            <li>
              <a href="/track" className="text-sm hover:underline">
                Track Order
              </a>
            </li>
          </ul>
        ...
        <div className="md:w-1/3">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              />
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Flipkart_logo.svg/2560px-Flipkart_logo.svg.png"
                alt="Flipkart"
                className="h-6"
                loading="lazy"
              />
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Meesho_Logo.png/1200px-Meesho_Logo.png"
                alt="Meesho"
                className="h-6"
                loading="lazy"
              />
              <img
                src="https://1000logos.net/wp-content/uploads/2021/02/Myntra-logo.png"
                alt="Myntra"
                className="h-6"
                loading="lazy"
              />
              <img
                src="https://logos-world.net/wp-content/uploads/2022/01/Ajio-Logo.png"
                alt="Ajio"
                className="h-6"
                loading="lazy"
              />
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/b/be/Tata_Cliq_Logo.svg"
                alt="TataCliq"
                className="h-6"
                loading="lazy"
              />
